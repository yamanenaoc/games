        ...
        if(objF[i] == true) {
            ...
            if(getDis(objX[i], objY[i], ssX, ssY) < r) {
                ...
                if(objType[i] == 2) {//アイテム
                    ...
                    if(objImg[i] ==11) laser = laser + 1000;
                }
            }
...
//敵をセットする
function setEnemy() {
    if(tmr%10 ==  0) setObject(1, 5, 1300, 60+rnd(600), -16, 0, 10);//敵機1
    if(tmr%10 == 2) setObject(1, 6, 1300, 60+rnd(600), -12, 8, 10);//敵機2
    if(tmr%5 == 0) setObject(1, 7, 1300, 360+rnd(300), -48, -10, 5);//敵機3
    if(tmr%50 == 6) setObject(1, 8, 1300, rnd(720-192), -5, 0, 100);//障害物
}
